...
model = dict(
    ...
    backbone=dict(
        type='SwinTransformerv2', # XYZ TODO
        img_size=1024, # XYZ TODO 2022.12.06
        embed_dim=96,
        depths=[2, 2, 6, 2],
        num_heads=[3, 6, 12, 24],
    ...
    roi_head=dict(
        ...
        bbox_head=dict(
            ...
            # type='ConvFCBBoxLMHead', # XYZ TODO
            in_channels=256,
            ...
            loss_cls=dict(
                type='CrossEntropyLoss', use_sigmoid=False, loss_weight=1.0), # XYZ TODO
            loss_bbox=dict(type='SmoothL1Loss', loss_weight=2.0)), # 2022.11.0611.XYZ TODO
            # loss_bbox=dict(type='L1Loss', loss_weight=2.0),# 11.XYZ TODO
            # loss_bbox=dict(type='CIoULoss', loss_weight=2.0),# 11.XYZ TODO
            # loss_lm=dict(type='L1Loss', loss_weight=1.0)), # XYZ TODO
            # loss_lm=dict(type='SmoothL1Loss', loss_weight=1.0)), # 2022.11.06 XYZ TODO
