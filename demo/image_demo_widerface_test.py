...
def main():
    ...
    parser.add_argument('--save_folder', default='./widerface_evaluate/swinorinmstest_testset/', type=str, help='Dir to save txt results')
    # parser.add_argument('--dataset_folder', default='/home/techart/xyz/xyz/xyz/data/WIDER_FACE/images/', type=str, help='dataset path')
    parser.add_argument('--dataset_folder', default='/home/techart/xyz/swin/swin_master/data/WIDERFace/WIDER_test/', type=str, help='dataset path')
    # parser.add_argument(
    #     '--img',
    #     type=str,
    ...
    parser.add_argument('--checkpoint',default="/home/techart/xyz/swin/swin_master/work_dirs/mask_rcnn_swin_tiny_patch4_window7_mstrain_480-800_adamw_1x_coco_nmsori/latest.pth", 
    ...
    tmp_list = os.listdir(testset_folder)
    test_dataset = []
    for tmp in tmp_list:
        tmp_path = testset_folder + '/' + tmp
        tmp_jpg_list = os.listdir(tmp_path)
        for tmp_jpg in tmp_jpg_list:
            path = tmp + '/' + tmp_jpg
            test_dataset.append(path.strip())
